	        		...
	        		<div class="col-md-4" style="margin-top:1%;">
	        			<div class="box-bg-white leftBlock">
	        				<div class="text-center">
	        					...
	        					<h1 class="text-blue">Kotak Bank</h1>
	        					<!-- <h3 class="text-orange">Finance make easy</h3> -->
	        				</div>
	        			</div>
	        		</div>
	        		 
	        		<div class="col-md-8 summarySec">
	        			<div class="box-bg-white validate-form">
	        			<div class="text-center"><span class="glyphicon glyphicon-ok"></span></div>
	        				<h1 class="text-orange text-center">Mandate Request Submitted</h1>
	        				<div class="text-center">
	        					<h4>Your Mandate Registration Request with reference <b class="text-blue">20180410869432</b> submitted successfully.
	        					You will receive <b class="text-blue">Unique Mandate Reference Number(UMRN)</b> shortly.</h4>
	        				</div>
	        				
	        				<div class="row text-center">
									<div class="col-md-12">
										
										<button type="button" class="btn btn-default btn-save" style="text-transform: none;font-size: 16px;margin-top: 2rem;">Ok, Got it!</button>
									</div>
								</div>
	        				...
	        				<!-- <form class="login100-form ">
								<div class="row">
									<div class="col-md-6">
										<div class="wrap-input100 validate-input">
											<input class="input100" type="text" name="name" value="Rakesh Sharma">
										...
										<div class="wrap-input100 validate-input">
											<input class="input100" type="text" name="email" value="2,00,000">
										...
										<div class="wrap-input100 validate-input">
											<input class="input100" type="text" name="email" value="07-04-2018">
									...
									<div class="col-md-6">
										<div class="wrap-input100 validate-input">
											<input class="input100" type="text" name="mobileNo" value="9874563217">
								...
								<div class="row text-center">
									<div class="col-md-12">
										...
										<button type="button" class="btn btn-default btn-save" >Payments to NACH</button>
									</div>
								</div>
								</form> -->
	        			</div>
	        		...
	        		<div class="col-md-4">
						...
						<div class="container-login100">					
							<div class="wrap-login100">
								...
								<div class="row text-center">
									<div class="col-md-12">
										<button type="button" class="btn btn-default btn-save" >NACH</button>
