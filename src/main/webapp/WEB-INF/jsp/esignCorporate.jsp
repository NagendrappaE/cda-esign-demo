								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input id="sponserBankifsc" type="text" readonly="readonly"
											...
											style="text-transform: uppercase;" value="Kotak Bank" />
									</div>
								</div>
							</div>
						</div>
							...
							<div class="col-md-12">
								<div class="form-group">
									<input readonly="readonly" type="text" name=sponserBankName
										class="form-control" id="sponserLabel" value="KKBK000001">
								</div>
							</div>
						</div>
					</div>
...
<script type="text/javascript">
	function fun() {
		...
		if (dropDownValues == 'NACH00000000001') {
			sponserBankifsc.value = "KKBK00000012";
			utilityDesc.value = "DHFL Home Loans";
			sponserLabelNames.value = "Kotak Bank";
		}
	...
	function getData() {
		...
		if (names == 'KKBK00000001') {
			labelOne.value = "Kotak Bank";
		}
