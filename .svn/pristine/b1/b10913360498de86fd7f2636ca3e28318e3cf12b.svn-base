 ...
 *
 */
public class EmandateRoot {
	private String mandateInitDate;
	...
	private String mndStartDate;

	private String mndEnddate;

	public String getMandateInitDate() {
		return mandateInitDate;
	}

	public void setMandateInitDate(String mandateInitDate) {
	...
	public String getMndStartDate() {
		return mndStartDate;
	}

	public void setMndStartDate(String mndStartDate) {
		this.mndStartDate = mndStartDate;
	}

	public String getMndEnddate() {
		return mndEnddate;
	}

	public void setMndEnddate(String mndEnddate) {
